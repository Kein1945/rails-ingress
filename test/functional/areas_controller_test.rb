...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { BRLat: @area.BRLat, BRLng: @area.BRLng, LTLat: @area.LTLat, LTLng: @area.LTLng, name: @area.name }
    end
  ...
  test "should update area" do
    put :update, id: @area, area: { BRLat: @area.BRLat, BRLng: @area.BRLng, LTLat: @area.LTLat, LTLng: @area.LTLng, name: @area.name }
    assert_redirected_to area_path(assigns(:area))
  end

...
class PortalsControllerTest < ActionController::TestCase
  ...
  test "should create portal" do
    assert_difference('Portal.count') do
      post :create, portal: { address: @portal.address, lat: @portal.lat, lng: @portal.lng, name: @portal.name, uid: @portal.uid }
    end
  ...
  test "should update portal" do
    put :update, id: @portal, portal: { address: @portal.address, lat: @portal.lat, lng: @portal.lng, name: @portal.name, uid: @portal.uid }
    assert_redirected_to portal_path(assigns(:portal))
  end
